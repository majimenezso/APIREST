...
class UsersController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const permiso = yield database_1.default.query('SELECT * FROM users');
            res.json(permiso);
        });
    }
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const games = yield database_1.default.query('SELECT * FROM users WHERE id = ?', [id]);
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            res.json({ message: "The users was Updated" });
        });
    }
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
